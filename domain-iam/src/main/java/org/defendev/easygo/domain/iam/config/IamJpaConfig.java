...
public class IamJpaConfig {
    ...
    @Bean
    public EntityManagerFactory iamEmf(@Qualifier("iamAppDataSource") DataSource appDataSource) {
    ...
    @Bean
    public PlatformTransactionManager iamJpaTransactionManager(@Qualifier("iamEmf") EntityManagerFactory emf) {
